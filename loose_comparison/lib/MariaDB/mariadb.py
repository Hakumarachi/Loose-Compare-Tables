...
class Mariadb(Comparator):
    def __init__(self, version='latest'):
        ...
        super(Mariadb, self).__init__(image, version, port, self.environment)
...
def compare(options):
    ...
    versions = get_image_tags('mariadb', filter)
    Comparator.compare(options, Mariadb, versions)
